...
final class ExtensionTests: BaseTestCase {
    ...
    func testIssueContentUnwrap() {
        ...
        XCTAssertEqual(issue.issueContent, "Example issue", "Changing contnent should also change issueContent.")
    ...
    func testIssueTagUnwrap() {
        ...
        XCTAssertEqual(issue.issueTags.count, 0, "A new issue should hae no tags.")
        
        issue.addToTags(tag)
        XCTAssertEqual(issue.issueTags.count, 1, "Adding 1 tag to an issue should result in issueTags having one tag.")
    }
    ...
    func testIssueTagsList() {
        ...
        XCTAssertEqual(issue.issueTagsList, "My Tag", "Adding 1 tag to an issue sould make issueTagsList to be My Tag.")
    }
    
    func testIssuesSortingIsStable() {
    ...
    func testTagSortingIsStable() {
        ...
        tag2.name = "B Tag"
        tag2.id = UUID(uuidString: "FFFFFFFF-FFFF-45C1-9443-50019E1802FF")
        ...
        XCTAssertEqual([tag3, tag1, tag2], sorted, "Sorting tag arrat should use name then UUID")
    }
    ...
    func testDecodingString() {
        ...
        XCTAssertEqual(data, "Never ask a starfish for directions.", "The string match DecodableString.json")
    }
